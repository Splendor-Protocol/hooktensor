...
declare module '@polkadot/types/types/registry' {
  interface InterfaceTypes {
    ...
    PalletSubtensorAxonInfo: PalletSubtensorAxonInfo;
    ...
    PalletSubtensorPrometheusInfo: PalletSubtensorPrometheusInfo;
